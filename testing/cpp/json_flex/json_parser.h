...
constexpr inline int32_t errSymbol = 1;
...
class Parser final {
 public:
  ...
  explicit Parser(Listener&& listener, absl::FunctionRef<bool(absl::Status)> error_handler, int a_arg, bool b_arg)
      : listener_(std::forward<Listener>(listener)), error_handler_(error_handler), a(a_arg), b(b_arg) {
    pending_symbols_.reserve(startTokenBufferSize);
  }

  absl::Status Parse(Lexer& lexer) {
    return Parse(0, 43, lexer);
  }
 ...
 private:
  ...
  absl::Status action11([[maybe_unused]] stackEntry& lhs,
                        [[maybe_unused]] const stackEntry* rhs);
  absl::Status action17([[maybe_unused]] stackEntry& lhs,
                        [[maybe_unused]] const stackEntry* rhs);
  absl::Status action19([[maybe_unused]] stackEntry& lhs,
                        [[maybe_unused]] const stackEntry* rhs);
  absl::Status action20([[maybe_unused]] stackEntry& lhs,
                        [[maybe_unused]] const stackEntry* rhs);
